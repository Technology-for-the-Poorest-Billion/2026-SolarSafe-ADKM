...
![SOLARSAFE](images/SOLARSAFE.png)
...
![rich picture](images/rich_picture.png)
...
<p float="left">
  <img title="shade cloth mesh" src="images/shade_cloth_mesh.jpg" width="49%"/>
  <img title="bladder" src="images/bladder.jpg" width="49%"/>
</p>

We found that the base prototype (pictured below) worked successfully and dried 5.28% of the weight off the kernels.

![experiment trial](images/experiment_trial.png)
...
![experiment string mesh](images/experiment_string_mesh.png)
